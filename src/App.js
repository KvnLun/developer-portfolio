...
const Portfolio = () => {
  ...
  const fullText = "COBOL & Java Developer | WebServices & Microservices Expert";
  ...
  const skills = [
    { name: 'COBOL', icon: <Code2 className="w-8 h-8" />, level: 95, color: 'from-cyan-400 to-blue-500' },
    { name: 'Java', icon: <Server className="w-8 h-8" />, level: 90, color: 'from-green-400 to-emerald-500' },
    { name: 'Python', icon: <Terminal className="w-8 h-8" />, level: 88, color: 'from-blue-400 to-indigo-500' },
    { name: 'Z/OS', icon: <Cpu className="w-8 h-8" />, level: 85, color: 'from-yellow-400 to-orange-500' },
    { name: 'PostgreSQL', icon: <Database className="w-8 h-8" />, level: 82, color: 'from-purple-400 to-pink-500' },
    { name: 'JCL', icon: <Globe className="w-8 h-8" />, level: 80, color: 'from-orange-400 to-red-500' },
    { name: 'Springboot', icon: <Smartphone className="w-8 h-8" />, level: 75, color: 'from-pink-400 to-rose-500' },
    { name: 'R', icon: <GitBranch className="w-8 h-8" />, level: 80, color: 'from-gray-400 to-gray-600' }
  ];
  ...
  const experience = [
    {
      ...
      period: '2024 - 2026',
      location: 'Denver, CO',
      description: 'Develop and maintain critical banking systems using COBOL and Java, supporting both legacy mainframe applications and modern microservices architecture. Ensure seamless integration between core banking systems and digital channels.',
      achievements: [
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg leading-relaxed text-gray-400">
                Versatile developer specializing in both legacy mainframe systems and modern Java ecosystems, with hands-on experience supporting critical financial infrastructure. I excel at maintaining COBOL-based core banking applications while developing innovative solutions using Java, Spring Framework, and microservices architecture.
              </p>
              <p className="text-lg leading-relaxed text-gray-400">
                My expertise spans JCL batch processing, VSAM/DB2 database management, and CICS transaction processing, complemented by modern skills in REST API development, containerization, and cloud deployment. I'm passionate about ensuring system reliability, optimizing performance, and facilitating the digital transformation journey for financial institutions.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className={`p-4 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <Zap className="w-8 h-8 text-yellow-500 mb-2" />
                  <h3 className="font-bold mb-1">Fast Learner</h3>
                  <p className="text-sm text-gray-400">Quick to adapt to and learn new technologies</p>
                </div>
                <div className={`p-4 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <Award className="w-8 h-8 text-green-500 mb-2" />
                  <h3 className="font-bold mb-1">Problem Solver</h3>
                  <p className="text-sm text-gray-400">Creative solutions to complex challenges and business needs</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <a href="mailto:kvn.loun@gmail.com" className={`flex items-center space-x-3 p-4 rounded-lg ${darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-100 hover:bg-gray-200'} transition-colors`}>
                  <Mail className="w-5 h-5 text-purple-500" />
                  <span>Email</span>
                </a>
                <a href="https://www.linkedin.com/in/kevin-loun/" target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-3 p-4 rounded-lg ${darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-100 hover:bg-gray-200'} transition-colors`}>
                  <Linkedin className="w-5 h-5 text-blue-500" />
                  <span>LinkedIn</span>
                </a>
                <a href="https://github.com/KvnLun" target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-3 p-4 rounded-lg ${darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-100 hover:bg-gray-200'} transition-colors`}>
